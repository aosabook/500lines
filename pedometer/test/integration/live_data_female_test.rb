...
class LiveDataFemaleTest < Test::Unit::TestCase
  ...
  def test_gravity_walking_10_steps_1
    get '/metrics', :device => {:data => File.read('test/data/female/walking-10-g-1.txt'), :rate => 100}, :user => {:stride => 90}
  ...
  def test_gravity_walking_10_steps_2
    get '/metrics', :device => {:data => File.read('test/data/female/walking-10-g-2.txt'), :rate => 100}, :user => {:stride => 90}
  ...
  def test_gravity_jogging_10_steps_1
    get '/metrics', :device => {:data => File.read('test/data/female/jogging-10-g-1.txt'), :rate => 100}, :user => {:stride => 90}
  ...
  def test_gravity_jogging_10_steps_2
    get '/metrics', :device => {:data => File.read('test/data/female/jogging-10-g-2.txt'), :rate => 100}, :user => {:stride => 90}
  ...
  def test_gravity_bag_10_steps_1
    get '/metrics', :device => {:data => File.read('test/data/female/bag-10-g-1.txt'), :rate => 100}, :user => {:stride => 90}
  ...
  def test_gravity_bag_10_steps_2
    get '/metrics', :device => {:data => File.read('test/data/female/bag-10-g-2.txt'), :rate => 100}, :user => {:stride => 90}
