...
class LiveDataFemaleTest < Test::Unit::TestCase
  ...
  def test_gravity_walking_10_steps_1
    get '/metrics', :data => File.read('test/data/male/walking-10-g-1.txt'), :user => {:stride => 90, :rate => 100}
  ...
  def test_gravity_walking_10_steps_2
    get '/metrics', :data => File.read('test/data/male/walking-10-g-2.txt'), :user => {:stride => 90, :rate => 100}
  ...
  def test_gravity_jogging_10_steps_1
    get '/metrics', :data => File.read('test/data/male/jogging-10-g-1.txt'), :user => {:stride => 90, :rate => 100}
  ...
  def test_gravity_jogging_10_steps_2
    get '/metrics', :data => File.read('test/data/male/jogging-10-g-2.txt'), :user => {:stride => 90, :rate => 100}
  ...
  def test_gravity_bag_10_steps_1
    get '/metrics', :data => File.read('test/data/male/bag-10-g-1.txt'), :user => {:stride => 90, :rate => 100}
  ...
  def test_gravity_bag_10_steps_2
    get '/metrics', :data => File.read('test/data/male/bag-10-g-2.txt'), :user => {:stride => 90, :rate => 100}
