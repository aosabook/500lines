...
class FilterTest < Test::Unit::TestCase
  ...
  def test_filter_gravity
    ...
    assert_equal expected, Filter.chebyshev_filter(data, Filter::GRAVITY)
  end
  ...
  def test_filter_smoothing
    ...
    assert_equal expected, Filter.chebyshev_filter(data, Filter::SMOOTHING)
  end
  ...
  def test_filter_highpass
    ...
    assert_equal expected, Filter.chebyshev_filter(data, Filter::HIGHPASS)
  end
