...
/******/ 	var hotCurrentHash = "dd378b35a26c00224d71";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __HUA = (function () { var React = __webpack_require__(7); var getHotUpdateAPI = __webpack_require__(4); return getHotUpdateAPI(React, "main.ls", module.id); })(); if (true) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "main.ls" + ": " + err.message); } }); module.hot.dispose(function () { var nextTick = __webpack_require__(6); nextTick(__HUA.updateMountedInstances); }); }

	var React, ref$, table, thead, tbody, tr, th, td, input, div, button, SheetDefault, SheetInit, Table, Row, Cell, slice$ = [].slice;
	...
	Table = React.createFactory(__HUA.createClass({
	  displayName: 'Table',
	...
	Row = React.createFactory(__HUA.createClass({
	  displayName: 'Row',
	  render: function(){
	...
	Cell = React.createFactory(__HUA.createClass({
	  displayName: 'Cell',
	  render: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updaters = {},
	    makeModuleUpdater = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (React, filename) {
	  ...
	  function createClass(spec) {
	    ...
	    componentUpdater = __webpack_require__(10)(React);
