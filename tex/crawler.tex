...
\KeywordTok{def} \NormalTok{fetch(url):}
    ...
    \NormalTok{request = }\StringTok{'GET \{\} HTTP/1.0}\CharTok{\textbackslash{}r\textbackslash{}n\textbackslash{}r\textbackslash{}n}\StringTok{'}\NormalTok{.}\DataTypeTok{format}\NormalTok{(url)}
...
\begin{Highlighting}[]
    ...
    \KeywordTok{def} \NormalTok{connected(}\OtherTok{self}\NormalTok{, key, mask):}
        ...
        \NormalTok{request = }\StringTok{'GET \{\} HTTP/1.0}\CharTok{\textbackslash{}r\textbackslash{}n\textbackslash{}r\textbackslash{}n}\StringTok{'}\NormalTok{.}\DataTypeTok{format}\NormalTok{(}\OtherTok{self}\NormalTok{.url)}
