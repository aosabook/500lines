...
source for each chapter can be found in the \url{src} subdirectory of project folder. 
...
\emph{Leo Zovic}: Leo is a Ruby/Go developer at 500px. He likes programming, and learning new programming languages. 
